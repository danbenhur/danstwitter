...
export default class RegistrationForm {
    constructor() {
        this._csrf = document.querySelector('[name="_csfr"]').value
  ...
  this.password.addEventListener("blur", () => {
    ...
    usernameHandler() {
        ...
        this.username.timer = setTimeout(() => this.usernameAfterDelay(), 770)
    }
    ...
    passwordHandler() {
        ...
        this.password.timer = setTimeout(() => this.passwordAfterDelay(), 770)
    }
    ...
    emailHandler() {
        ...
        this.email.timer = setTimeout(() => this.emailAfterDelay(), 770)
    }
